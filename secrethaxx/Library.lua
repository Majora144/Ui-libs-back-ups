    ...
    do
        ...
        do
            ...
            Library.Font = CustomFont:New("WindowsXPTAHOMA", 400, "Regular", {
                Id = "WindowsXPTAHOMA",
                Url = "https://github.com/Majora144/str/raw/refs/heads/fonts/TAHOMA-8PT-BOLD-WINDOWS-XP.ttf",
            })

            Library.BoldFont = CustomFont:New("Tahoma8PTBOLD", 400, "Regular", {
                Id = "Tahoma8PTBOLD",
                Url = "https://github.com/Majora144/str/raw/refs/heads/fonts/windows-xp-tahoma.ttf",
            })
        end
        ...
        Library.MakeResizeable = function(Self, Minimum)
            ...
            local Edges = {
                {
                    Button = MakeEdge("Left", UDim2.new(0, 0, 0, 0), UDim2.new(0, EdgeThickness, 1, 0)),
                    Side = "L",
                },

                {
                    Button = MakeEdge("Right", UDim2.new(1, -EdgeThickness, 0, 0), UDim2.new(0, EdgeThickness, 1, 0)),
                    Side = "R",
                },

                {
                    Button = MakeEdge("Top", UDim2.new(0, 0, 0, 0), UDim2.new(1, 0, 0, EdgeThickness)),
                    Side = "T",
                },

                {
                    Button = MakeEdge("Bottom", UDim2.new(0, 0, 1, -EdgeThickness), UDim2.new(1, 0, 0, EdgeThickness)),
                    Side = "B",
                },
            }
        ...
        do
            Library.CreateColorpicker = function(Self, Data)
                ...
                function Colorpicker:SetOpen(Bool)
                    ...
                    if Colorpicker.IsOpen then
                        ColorpickerWindow.Position = UDim2.new(
                            ...
                            0,
                            ColorpickerButton.AbsolutePosition.Y + ColorpickerButton.AbsoluteSize.Y + GuiInset
                        )
                ...
                function Colorpicker:SlideHue(Input)
                    ...
                    Items["HueDragger"]:Tween(
                        { Position = UDim2.new(0, 0, SlideY, 0) },
                        TweenInfo.new(Library.Animation.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
                    )
                    Colorpicker:Update()
                end
                ...
                function Colorpicker:SlideAlpha(Input)
                    ...
                    Items["AlphaDragger"]:Tween(
                        { Position = UDim2.new(SlideX, 0, 0, 0) },
                        TweenInfo.new(Library.Animation.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
                    )
                ...
                function Colorpicker:Set(Color, Alpha)
                    ...
                    Items["HueDragger"]:Tween(
                        { Position = UDim2.new(0, 0, HuePositionY, 0) },
                        TweenInfo.new(Library.Animation.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
                    )
                    Items["AlphaDragger"]:Tween(
                        { Position = UDim2.new(AlphaPositionX, 0, 0, 0) },
                        TweenInfo.new(Library.Animation.Time, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
                    )
                    Colorpicker:Update()
                end
            ...
            Library.CreateKeybind = function(Self, Data)
                ...
                function Keybind:Set(Key)
                    ...
                    elseif type(Key) == "table" then
                        ...
                        local TextToDisplay = KeyString
                                and string.gsub(string.gsub(KeyString, "KeyCode.", ""), "UserInputType.", "")
                            or "None"
                ...
                Library:Connect(UserInputService.InputBegan, function(Input, GPE)
                    ...
                    if
                        Keybind.IsOpen
                        and not Items["KeybindWindow"]:IsMouseOverFrame()
                        and not ModeDropdown.Items.OptionHolder:IsMouseOverFrame()
                    then
            ...
            Library.TargetIndicator = function(Self, Params)
                ...
                function Indicator:SetStatus(Text, Color)
                    if typeof(Color) == "Color3" then
                        Items["Status"].Instance.Text = '<font color="rgb('
                ...
                function Toggle:Settings()
                    ...
                    function Settings:SetOpen(Bool)
                        if Bool then
                            ...
                            SettingsItems["Connect"]:Tween({
                                Size = UDim2.new(0, 2, 0, SettingsItems["Content"].Instance.AbsoluteSize.Y + 1),
                            })
                        else
